    ...
    useEffect(() => {
     ...
     const scroll = (scrollOffset) => {
        ...
        return <div className='bg-white round-border p-3 mt-3'>
                    ...
                    <div>
                        <span className="h4 mx-2 round-hover" onClick={(e)=>this.scroll(-20)}><IoIosArrowBack/></span>
                        <span className="h4 mx-2 round-hover" onClick={(e)=>this.scroll(+20)}><IoIosArrowForward/></span>
                    ...
                    <div className=' featured-cards mt-3  row-cols-sm-2 row-cols-md-3  row-col-xl-4' >
                        {infos && infos.map((info,i)=> <SingleFeaturedCard key={i} info={info}/>) 
