...
function RightSide() {
  return (<>
  <div className='bg-white p-3 pb-0 w-100 round-border mt-2' style={{fontSize:'12px'}}>
          <p className='h6 bold mb-2'>Add to you feed</p>
          <div className='d-flex mt-2'>
            <div style={{width:'75px', height:'75px',marginRight:'5px'}}>
              <img className='w-100' src='https://images.unsplash.com/photo-1453728013993-6d66e9c9123a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8dmlld3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60' alt='camera lens'/>
            </div>
            <div>
          ...
          <div className='d-flex '>
            <div style={{width:'75px', height:'75px',marginRight:'5px'}}>
              <img className='w-100' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-mY9GvoISl_wimVW63GqLNxprGzE6Q0kv6Uw0dZTrjJqzmWHySJJohv1dEARQcT0Y7jc&usqp=CAU' alt='mercedez'/>
            </div>
            <div>
  ...
  <div className='footer-feeds d-flex w-100 flex-wrap justify-content-around mt-3 px-4' style={{fontSize:'12px'}}>
              <span>About</span>
            ...
            <span>More</span>
            <p>
            <span ><img className='w-100'style={{maxWidth:'40px',maxHeight:'40px'}} src='https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/LinkedIn_Logo.svg/1024px-LinkedIn_Logo.svg.png' alt='linkedin logo'/>
            </span>
